...
/*
 * https://github.com/FinGu/c_auth/blob/main/functions/general/mysqli_wrapper.php
 */

class mysqli_wrapper{
    private $connection, $xss_prevention;

    public function __construct($host, $username, $password, $db_name, $xss_prevention = false, $port) { //extra
